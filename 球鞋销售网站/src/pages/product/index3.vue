<template>
	<div>
  	...
  	<el-table :data="products" border style="width: 100%">
		...
		<el-table-column prop="name" label="球星姓名" align="center" width="100"></el-table-column>
		<el-table-column prop="description" label="描述" align="center"></el-table-column>
		<el-table-column  width="80px" prop="status" label="销量" align="center"></el-table-column>
  ...
  <el-dialog :title="title" :visible.sync="dialogFormVisible">
    <el-form :model="form">
    <el-form-item label="喜爱球星">
      <el-input v-model="form.name" clearable placeholder="请输入喜爱球星"></el-input>
    </el-form-item>
