<template>
	<div>
		...
		<el-table-column prop="name" label="球鞋气垫" align="center" width="100"></el-table-column>
  ...
  <el-dialog :title="title" :visible.sync="dialogFormVisible">
   <el-form :model="form">
    <el-form-item label="球鞋气垫">
      <el-input v-model="form.name" clearable placeholder="请输入球鞋气垫"></el-input>
    </el-form-item>
