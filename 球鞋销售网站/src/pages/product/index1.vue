<template>
	<div>
		...
		<el-table-column prop="name" label="球鞋品牌" align="center" width="150px"></el-table-column>
		...
		<el-table-column  prop="photo" label="照片" width="140px">
  ...
  <el-form :model="form" :rules="rules">
    <el-form-item label="球鞋品牌" prop="name">
      <el-input v-model="form.name" clearable placeholder="请输入球鞋品牌"></el-input>
    </el-form-item>
	...
	export default{
		data(){
			return {
				...
				rules: {
					name: [
					{ required: true, message: '请输入球鞋品牌', trigger: 'change' }
					],
					description: [
