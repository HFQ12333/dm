<template>
  ...
  <div class="manager">
    ...
    <van-tabbar route active-color="#1659a0">
      ...
      <van-tabbar-item icon="https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2775894806,4199798843&fm=26&gp=0.jpg" to="/manager/Product">购物车</van-tabbar-item>
