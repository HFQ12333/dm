<template>
  ...
  <van-goods-action-icon icon="cart-o" @click="jiarugwc" text="购物车" info="9" />
  <van-goods-action-icon icon="shop-o" text="店铺" />
  <van-goods-action-button color="#be99ff" @click="jiarugwc" text="加入购物车" type="warning" />
  <van-goods-action-button color="#7232dd" @click="submitHandler" block type="primary" text="立即购买" />
</van-goods-action>
    </div>
  </briup-fulllayout>
</template>
